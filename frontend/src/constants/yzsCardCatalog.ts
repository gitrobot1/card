...
export const YZS_BASIC_CARDS: CodexCardEntry[] = [
  ...
  },
  {
    kind: 'sha_fire',
    name: '火杀',
    effect: '视为【杀】，造成火焰伤害（可被【藤甲】加成、可传导【铁索连环】）。',
  },
  {
    kind: 'sha_thunder',
    name: '雷杀',
    effect: '视为【杀】，造成雷电伤害（对特定技能有额外效果）。',
  },
  {
    kind: 'shan',
    name: '闪',
...
export const YZS_TRICK_CARDS: CodexCardEntry[] = [
  {
    kind: 'guohe',
    name: '过河拆桥',
    effect: '出牌阶段，对一名有牌的其他角色使用，弃置其区域内的一张牌。',
  },
  {
    kind: 'tannang',
    name: '顺手牵羊',
    effect: '出牌阶段，对距离 1 以内有牌的其他角色使用，获得其区域内的一张牌。',
  },
  {
    kind: 'wuzhong',
    name: '无中生有',
  ...
  },
  {
    kind: 'nanman',
    name: '南蛮入侵',
    effect: '出牌阶段使用，所有其他角色依次需打出【杀】，否则受到 1 点伤害（装备【藤甲】者无效）。',
  },
  {
    kind: 'wanjian',
    name: '万箭齐发',
    effect: '出牌阶段使用，所有其他角色依次需打出【闪】，否则受到 1 点伤害（装备【藤甲】者无效）。',
  },
  {
    kind: 'juedou',
    name: '决斗',
    effect: '出牌阶段，对一名其他角色使用；由目标开始，双方轮流打出【杀】，先不出者受到 1 点伤害。',
  },
  {
    kind: 'wuxiek',
    name: '无懈可击',
  ...
  },
  {
    kind: 'tiesuo',
    name: '铁索连环',
    effect: '出牌阶段，对一至两名角色使用令其横置/重置；或重铸（弃置此牌并摸一张，不计入锦囊）。横置角色受到火焰或雷电伤害时传导至其他横置角色，传导后重置。可被无懈可击抵消。',
  },
  {
    kind: 'lebu',
    name: '乐不思蜀',
